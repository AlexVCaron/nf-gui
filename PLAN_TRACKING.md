...
| P0-06, P0-08 | Complete | [Phase 0 capability matrix and baseline selections](docs/plan/phase-0-capability-matrix.md) now document the selected managed toolchain baseline, the project-compatibility policy, the versioned capability matrix for the `26.04` language-server line, and the feature-to-semantics/edit-path mapping for the initial release boundary. Secret scanning passed and documentation review/CodeQL validation were completed for the earlier audit updates; re-run validation after this matrix update. | Phase 0 exit is still blocked by P0-01/P0-03 evidence gaps and the phase-1 Monaco integration spike. |
